...
import static ru.graduation.voting.TestUtil.readListFromJsonMvcResult;
...
public class TestMatcher<T> {
    ...
    public static <T> TestMatcher<T> usingFieldByFieldAssertions(Class<T> clazz) {
        return usingAssertions(clazz,
                (a, e) -> assertThat(a).isEqualToComparingFieldByField(e),
                (a, e) -> assertThat(a).usingFieldByFieldElementComparator().isEqualTo(e));
    }
